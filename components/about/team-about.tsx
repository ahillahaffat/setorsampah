...
const TeamMember = ({
  ...
  <div className="w-full px-4 sm:w-1/2 lg:w-1/4 xl:w-1/4">
          <div className="group shadow-testimonial dark:shadow-none mb-8 rounded-xl bg-gray-120 dark:bg-dark px-5 pt-12 pb-10">
            ...
            <div className="text-center">
              ...
              <div className="flex items-center gap-5 justify-center">
                <a
                  ...
                  className="hover:text-green-500 text-dark-6"
                >
                  <svg
                    width="18"
                    height="18"
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="hover:text-green-700 text-dark-6"
                >
                  <svg
                    width="18"
                    height="18"
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="hover:text-primary text-dark-6"
                >
                  <svg
                    width="18"
                    height="18"
