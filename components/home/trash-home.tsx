...
const TrashHome = () => {
  ...
  return (
    <section className="p-8 lg:pt-[70px] lg:pb-[70px]">
        ...
        <div className="-mx-4 flex flex-wrap">
          <div className="w-full px-4 md:w-1/2 lg:w-1/3">
            <div className="wow fadeInUp group mb-12 " data-wow-delay=".1s">
              <div
                className="relative z-10 mb-10 flex h-[70px] w-[70px] items-center justify-center rounded-[14px] bg-green-50">
                <span
                  className="absolute top-0 left-0 -z-[1] mb-8 flex h-[70px] w-[70px] rotate-[25deg] items-center justify-center rounded-[14px] bg-green-50 bg-opacity-20 duration-300 group-hover:rotate-45"></span>
              ...
              <p className="mb-8 text-gray-120 lg:mb-9">
              Sampah kertas yang dibawa pendaki ke gunung termasuk kemasan makanan/minuman, kartu, buku catatan, dan kertas bekas aktivitas. Semua ini bisa didaur ulang menjadi kertas baru.
              </p>
            </div>
          </div>
          <div className="w-full px-4 md:w-1/2 lg:w-1/3">
            <div className="wow fadeInUp group mb-12" data-wow-delay=".15s">
              ...
              <p className="mb-8 text-gray-120 lg:mb-9">
              Sampah plastik yang dibawa pendaki ke gunung bisa berupa botol minuman, bungkus makanan, kantong plastik, atau wadah plastik lainnya. Semua ini bisa didaur ulang menjadi produk plastik baru setelah dipilah dan diproses dengan benar.
              </p>
            </div>
          </div>
          <div className="w-full px-4 md:w-1/2 lg:w-1/3">
            <div className="wow fadeInUp group mb-12" data-wow-delay=".2s">
              ...
              <p className="mb-8 text-gray-120 lg:mb-9">
              Sampah kaleng yang biasanya dibawa pendaki ke gunung meliputi kaleng minuman, makanan kaleng, atau wadah logam lainnya. Semua ini bisa didaur ulang untuk membuat produk logam baru setelah dipilah dan diproses dengan benar.
              </p>
            </div>
          </div>
        </div>
